...
const CreatePost = () => {
  ...
  const [suggestedTags] = useState(['React', 'TailwindCSS', 'JavaScript', 'WebDev', 'Tutorial', 'Design', 'Animation', 'Responsive']);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-100/80 space-y-2">
            ...
            <button className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50/80 hover:text-gray-900 transition-all duration-200 group">
      ...
      <main className="flex-1 min-w-0 overflow-hidden">
        ...
        <div className="lg:hidden bg-white/90 backdrop-blur-xl border-b border-gray-200/80 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
          ...
          <h1 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Create Post</h1>
        ...
        <div className="max-w-7xl mx-auto p-4 lg:p-8">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center space-x-3">
                <button className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 flex items-center space-x-2 shadow-sm">
            ...
            <div className="lg:col-span-2 space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-gray-500 text-sm">yourblog.com/post/</span>
                    <input
                      type="text"
                      name="slug"
                      value={formData.slug}
                  ...
                  {!formData.coverImagePreview ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <button
                          type="button"
                          className="mt-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                        >
                          Browse Files
                        </button>
                      </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <div className="space-y-3">
                        ...
                        <div className="absolute z-10 w-full mt-1 bg-white rounded-xl border border-gray-200 shadow-lg max-h-48 overflow-y-auto animate-fade-in">
                          {filteredSuggestions.map((suggestion, index) => (
                            ...
                            >
                              ...
                              <Plus className="w-4 h-4 text-gray-400 group-hover:text-blue-500 opacity-0 group-hover:opacity-100 transition-all" />
                            </button>
                          ))}
                        </div>
                      )}
                    ...
                    <p className="text-xs text-gray-500">
                      Press <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-200 rounded text-[10px] font-mono">Enter</kbd> or <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-200 rounded text-[10px] font-mono">,</kbd> to add tags
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 p-6 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-1.5 mb-3 pb-3 border-b border-gray-100">
                    {['Bold', 'Italic', 'Link', 'Image', 'Quote', 'Code'].map((tool, index) => (
                      <button
                        key={index}
                        type="button"
                        className="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50/80 rounded-lg transition-all duration-200"
                        title={tool}
                      >
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-green-700 text-xs">
                        yourblog.com/post/{formData.slug || 'your-slug'}
                      </p>
                      <p className="text-gray-600 text-sm line-clamp-2">
                        {formData.excerpt || 'Your excerpt will appear here. This is a preview of how your post will look in search results. Make sure to write a compelling description to attract clicks.'}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-600 line-clamp-1 mt-0.5">
                          {formData.excerpt || 'Your excerpt will appear here when shared on social media platforms.'}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1.5">Featured Post</label>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50/50 rounded-2xl border border-blue-100/50 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-white/70 rounded-xl">
                    <p className="text-2xl font-bold text-blue-600">{formData.content.split(/\s+/).filter(w => w.length > 0).length}</p>
                    <p className="text-xs text-gray-500 mt-1">Words</p>
                  </div>
                  <div className="text-center p-3 bg-white/70 rounded-xl">
                    <p className="text-2xl font-bold text-indigo-600">{formData.content.length}</p>
                  ...
                  <div className="text-center p-3 bg-white/70 rounded-xl">
                    <p className="text-2xl font-bold text-amber-600">~{Math.ceil(formData.content.split(/\s+/).filter(w => w.length > 0).length / 200)} min</p>
